...
bool Sudoku::judgeQ1(int sudokuBoard2[9][9])
{
	for(int i=0;i<9;i++)
	{
		for(int j=0;j<9;j++)
...
bool Sudoku::judgeQ2(int sudokuBoard2[9][9])
{
	for(int j=0;j<9;j++)
	{
		for(int i=0;i<9;i++)
...
bool Sudoku::judge(int judgeB[9][9])
{
...
bool Sudoku::checkU(int s[9][9],int &row,int &col)
{
	for(row=0;row<9;row++)
	{
		for(col=0;col<9;col++)
...
bool Sudoku::checkRow(int s[9][9],int row,int num)
{
	for(int col=0;col<9;col++)
	{
		if(s[row][col]==num)
...
bool Sudoku::checkCol(int s[9][9],int col,int num)
{
...
bool Sudoku::checkBox(int s[9][9],int rowBegin,int colBegin,int num)
{
	for(int row=0;row<3;row++)
	{
		for(int col=0;col<3;col++)
...
bool Sudoku::safe(int s[9][9],int row,int col,int num)
{
	return (checkRow(s,row,num)==false)&&(checkCol(s,col,num)==false)&&(checkBox(s,row-row%3,col-col%3,num)==false);
}
